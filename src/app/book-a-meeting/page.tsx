      ...
      <div className="mx-6 w-auto max-w-[1200px] md:mx-12 lg:mx-auto lg:w-[90%] xl:w-[88%] 2xl:w-[75%]">
        ...
        <div className="mb-8 mt-10 md:mb-12">
          <p
            ...
            className="booking-kicker mb-2 font-nm-book text-sm md:text-base"
          >
            Let&apos;s connect
          </p>
          <h1
            data-page-motion-heading
            className="booking-title font-nm-medium text-[clamp(2.625rem,6vw,4.75rem)] font-medium leading-[0.96] tracking-[-0.035em] text-black"
          >
            Book a Meeting
          </h1>
          <p
            data-page-motion-copy
            className="booking-copy mt-5 max-w-2xl font-nm-book text-base leading-6 text-[#4A4A4A] md:text-lg md:leading-7"
          >
