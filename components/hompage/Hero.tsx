    ...
    >
      <div className="container-wrapper relative z-10 h-auto w-full xl:h-full">
        <div
          ...
          className="app-container mx-6 flex min-h-[calc(100svh-132px)] w-auto max-w-[1200px] flex-col md:mx-12 md:min-h-[calc(100svh-160px)] lg:mx-auto lg:min-h-[calc(100svh-168px)] lg:w-[90%] xl:h-full xl:min-h-0 xl:w-[88%] 2xl:w-[75%]"
        >
          <div
          ...
          >
            <div className="flex items-center">
              <div
                className={`${styles["hero-content"]} relative z-10 mx-auto w-full max-w-[640px] xl:mx-0`}
              >
                <h1
                  id="hero-title"
                  className={`${styles["hero-heading"]} mx-auto max-w-max text-center font-nm-medium text-[clamp(1.875rem,9vw,3.1rem)] font-medium leading-[0.92] tracking-[-0.055em] text-white sm:text-[clamp(3.2rem,7.1vw,4.3rem)] sm:leading-[0.94] xl:mx-0 xl:text-left xl:text-[clamp(3.55rem,4.3vw,4.65rem)] 2xl:text-[4.125rem]`}
                >
                  <span
                ...
                <div
                  ...
                  className={`${styles["hero-copy-wrap"]} mx-auto mt-6 max-w-[500px] text-center sm:mt-7 xl:mx-0 xl:text-left`}
                >
                  <p
                ...
                <div
                  ...
                  className={`${styles["hero-actions"]} mx-auto mt-7 grid w-full max-w-[380px] grid-cols-2 gap-3 xl:mx-0`}
                >
                  <Link
                    href="/#projects"
